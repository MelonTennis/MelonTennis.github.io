...
| <img src="https://raw.githubusercontent.com/YijiaJin/Plot/master/raid0.png" style="zoom:40%"> | <img src="https://raw.githubusercontent.com/YijiaJin/Plot/master/raid1.png" style="zoom:40%"> | <img src="https://raw.githubusercontent.com/YijiaJin/Plot/master/raid4.png" style="zoom:40%"> | <img src="https://raw.githubusercontent.com/YijiaJin/Plot/master/raid5.png" style="zoom:40%"> |
...
<img src="https://raw.githubusercontent.com/YijiaJin/Plot/master/raidCompare.png" style="zoom:50%">
...
Strip情况，系统的MTTDL = 硬盘MTTF／ 硬盘总数。Mirror情况，系统MTTDL = 1.5\*硬盘MTTF。举例如下。
...
奇偶校验码和镜像分别可以容忍一个错误。对于镜像，从正确的拷贝读取数据。对于奇偶校验码，已知错误硬盘，可以利用校验码XOR其他硬盘数据推断出正确比特。

No data loss, if fast enough: first failure fixed before second one happens

MTTDLarray = MTTFfirstdrive * (1 / prob of 2nd failure before repair) where prob is MTTRdrive / MTTFseconddrive

For mirroring: MTTDLpair = (MTTFdrive / 2) * (MTTFdrive / MTTRdrive)

For 5-disk parity-protected arrays: MTTDLset = (MTTFdrive / 5) * ((MTTFdrive / 4 )/ MTTRdrive)
